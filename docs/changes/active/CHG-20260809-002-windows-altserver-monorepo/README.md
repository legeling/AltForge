...
- `actionlint 1.7.7` 已检查初始 CI/Release workflows；五项 Release 产物 metadata/checksum fixture 通过。前两次 hosted Windows run 分别因 runner 系统 vcpkg 漂移、2026-08 revision 已移除 `cpprestsdk` 而失败；manifest 现固定到 deindex 前的 `d015e31e90838a4c9dfa3eed45979bc70d9357fc`，workflow 从 manifest 读取相同 revision，等待下一标签复验。
