...
- Status: Implemented locally; iOS/Windows build and physical-device acceptance pending
...
- No version, tag, release, commit or push was made. Source-only and macOS build checks do not satisfy device acceptance.
