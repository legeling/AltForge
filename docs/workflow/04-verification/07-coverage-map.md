...
| Apple authentication response compatibility | `FR-041` | `DES-027` | `TEST-040` | Published v2.4.4 (22): production-parser and two-factor HTTP fixtures, structured error preservation, bounded redacted diagnostics, 13 hosted tests, three-platform builds, downloaded checksums and public latest endpoints pass. Real-account login and installation remain unresolved; earlier 503 attribution was unverified. | `T-040` |
