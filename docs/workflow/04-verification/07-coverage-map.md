...
| Apple authentication response compatibility | `FR-041` | `DES-027` | `TEST-040` | CHG-20260905-002 adapts AltSign #47/#49: AuthKit identity, isolated sessions, bounded retries, structured error priority and privacy. All 17 selected XCTest passed locally; iOS test host/macOS Universal builds and test-app integrity passed. User confirmed successful macOS login and device preparation, authorizing 2.4.5. Full installation, other platform logins and the 2FA matrix remain unverified. | `T-040` |
