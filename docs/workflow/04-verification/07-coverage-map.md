...
| Apple authentication response compatibility | `FR-041` | `DES-027` | `TEST-040` | Source/static contract and macOS/iOS builds cover the shared Xcode 27 beta 6 product/bundle identity, runtime CFNetwork/Darwin User-Agent, rejection of Xcode 11 constants and safe malformed-response mapping; the built framework contains the new identity and excludes `3594.4.19`, while real Apple account/2FA/team/certificate and install validation remain pending | `T-040` |
