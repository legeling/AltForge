...
| Task | 状态 | 关联 | 完成标准 |
|---|---|---|---|
| `T-047` 跨端 IPA 安装与自定义图标裁切 | Local gates pass / CI and device pending | `FR-049`; `DES-034`; `TEST-048` | macOS 常显入口、两端检查/编辑/直接安装及裁切图标；本机 fixture/build/typecheck/contract 通过，iOS XCTest 与真机双路径、主屏幕图标及刷新待验收 |
