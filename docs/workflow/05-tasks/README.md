...
| `T-040` 修复 Apple 认证响应格式失败 | Released in v2.4.4 / real login unresolved | `FR-041`; `DES-027`; `TEST-040` | 已交付认证子步骤、HTTP/MIME 脱敏诊断，修复双重认证误报及畸形成功响应，保留 Apple 具体错误码；13 项 hosted XCTest、三平台 Release 构建、下载校验与 latest 回读通过。真实账号登录和设备安装恢复仍待新版复测 |
