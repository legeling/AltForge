...
| `T-019` 建立 macOS 单设备安装事务与多线路 Release 下载 | In progress | `FR-031`; `DES-017`; `TEST-030` | 设备级去重、对称阶段窗口、传输量/速度、手动切源取消、配置 CDN、固定镜像与 size/SHA-256 校验通过 static/build/full-hash network smoke；真实设备和完整切源/失败清理矩阵待验证 |
