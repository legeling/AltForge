...
源码构建主题的 6 条报告见 [`upstream/topics/07-build-and-development.md`](upstream/topics/07-build-and-development.md)，桌面分发与安装器主题的 50 条报告见 [`upstream/topics/06-desktop-distribution.md`](upstream/topics/06-desktop-distribution.md)。
