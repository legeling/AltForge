...
- [`v2.6.0`](v2.6.0.md)：跨端导入 IPA 时编辑名称、包标识符及裁切自定义图标；macOS 独立常显“安装 IPA”，真机回归待验收。
...
- [`v2.4.4`](v2.4.4.md)：认证阶段、HTTP/MIME 脱敏诊断与双重认证响应校验。
- [`v2.4.3`](v2.4.3.md)：macOS 检查更新直接下载、校验并打开安装器。
